...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Tutorial 2: Pong &mdash; SGE Game Engine 1.5 documentation</title>
      ...
      <ul>
        ...
        <li class="right" >
          <a href="py-modindex.html" title="Python Module Index"
             >modules</a> |</li>
        <li class="right" >
          <a href="pong_better.html" title="Tutorial 3: Better Pong"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="hello_world.html" title="Tutorial 1: Hello, world!"
...
<p>For our <a class="reference internal" href="dsp.html#sge.dsp.Game" title="sge.dsp.Game"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Game</span></code></a> class, we want to of course provide a way
...
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">event_close</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
...
simply use a combination of <a class="reference internal" href="gfx.html#sge.gfx.Sprite.from_screenshot" title="sge.gfx.Sprite.from_screenshot"><code class="xref py py-meth docutils literal"><span class="pre">sge.gfx.Sprite.from_screenshot()</span></code></a> and
<a class="reference internal" href="gfx.html#sge.gfx.Sprite.save" title="sge.gfx.Sprite.save"><code class="xref py py-meth docutils literal"><span class="pre">sge.gfx.Sprite.save()</span></code></a>.  To toggle fullscreen, we simply change the
value of <a class="reference internal" href="dsp.html#sge.dsp.Game.fullscreen" title="sge.dsp.Game.fullscreen"><code class="xref py py-attr docutils literal"><span class="pre">sge.dsp.Game.fullscreen</span></code></a>.  To pause the game, we use
<a class="reference internal" href="dsp.html#sge.dsp.Game.pause" title="sge.dsp.Game.pause"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Game.pause()</span></code></a>.  We end up with this:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">event_key_press</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">key</span><span class="p">,</span> <span class="n">char</span><span class="p">):</span>
...
<p>This is incomplete, though.  When <a class="reference internal" href="dsp.html#sge.dsp.Game.pause" title="sge.dsp.Game.pause"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Game.pause()</span></code></a> is called,
...
<code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Game.event_paused_key_pressed()</span></code> and
<a class="reference internal" href="dsp.html#sge.dsp.Game.event_paused_close" title="sge.dsp.Game.event_paused_close"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Game.event_paused_close()</span></code></a>:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">event_paused_key_press</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">key</span><span class="p">,</span> <span class="n">char</span><span class="p">):</span>
...
<p><a class="reference internal" href="dsp.html#sge.dsp.Object" title="sge.dsp.Object"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Object</span></code></a> objects are things in a game that we want to be
...
define two sub-classes of <a class="reference internal" href="dsp.html#sge.dsp.Object" title="sge.dsp.Object"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Object</span></code></a> for this purpose:
<code class="xref py py-class docutils literal"><span class="pre">Player</span></code> and <code class="xref py py-class docutils literal"><span class="pre">Ball</span></code>.</p>
...
<p><code class="xref py py-class docutils literal"><span class="pre">Player</span></code> is used for the paddles.  These are what the players
control.</p>
<p>For <code class="xref py py-class docutils literal"><span class="pre">Player</span></code>, the difference between different objects is which
...
are therefore going to define <code class="xref py py-meth docutils literal"><span class="pre">Player.__init__()</span></code> to reflect this.</p>
<p><code class="xref py py-meth docutils literal"><span class="pre">Player.__init__()</span></code> will take a single argument, <code class="docutils literal"><span class="pre">player</span></code>.  This
argument will indicate which player the object is for: <code class="docutils literal"><span class="pre">1</span></code> for player
1, or <code class="docutils literal"><span class="pre">2</span></code> for player 2.  We will set a few attributes based on this:</p>
<ul class="simple">
<li><code class="xref py py-attr docutils literal"><span class="pre">up_key</span></code> will indicate the key that moves the paddle up.  We
will set it to <code class="docutils literal"><span class="pre">&quot;w&quot;</span></code> for player 1, or <code class="docutils literal"><span class="pre">&quot;up&quot;</span></code> for player 2.</li>
<li><code class="xref py py-attr docutils literal"><span class="pre">down_key</span></code> will indicate the key that moves the paddle down.  We
will set it to <code class="docutils literal"><span class="pre">&quot;s&quot;</span></code> for player 1, or <code class="docutils literal"><span class="pre">&quot;down&quot;</span></code> for player 2.</li>
<li><code class="xref py py-attr docutils literal"><span class="pre">x</span></code> is an attribute inherited from <a class="reference internal" href="dsp.html#sge.dsp.Object" title="sge.dsp.Object"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Object</span></code></a> which
...
Python doesn&#8217;t support constants) called <code class="xref py py-const docutils literal"><span class="pre">PADDLE_XOFFSET</span></code>:
<code class="docutils literal"><span class="pre">PADDLE_XOFFSET</span></code> for player 1, or
<code class="docutils literal"><span class="pre">sge.game.width</span> <span class="pre">-</span> <span class="pre">PADDLE_XOFFSET</span></code> for player 2.  We will define
<code class="xref py py-const docutils literal"><span class="pre">PADDLE_XOFFSET</span></code> near the top of our code file, beneath
imports, as <code class="docutils literal"><span class="pre">32</span></code>.</li>
<li><code class="xref py py-attr docutils literal"><span class="pre">hit_direction</span></code> will indicate the direction the paddle hits the
ball.  We will set it to <code class="docutils literal"><span class="pre">1</span></code> for player 1, and <code class="docutils literal"><span class="pre">-1</span></code> for player 2.</li>
</ul>
<p>Additionally, certain attributes inherited from <a class="reference internal" href="dsp.html#sge.dsp.Object" title="sge.dsp.Object"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Object</span></code></a>
will be the same for both <code class="xref py py-class docutils literal"><span class="pre">Player</span></code> objects.  <code class="xref py py-attr docutils literal"><span class="pre">y</span></code> will
always be <code class="docutils literal"><span class="pre">sge.game.height</span> <span class="pre">/</span> <span class="pre">2</span></code> (vertically centered).  <code class="xref py py-attr docutils literal"><span class="pre">sprite</span></code>
will always be <code class="docutils literal"><span class="pre">paddle_sprite</span></code> (a sprite we will create later).
<code class="xref py py-attr docutils literal"><span class="pre">checks_collisions</span></code> will always be <code class="xref py py-const docutils literal"><span class="pre">False</span></code>, since player
...
<p>All attributes inherited from <a class="reference internal" href="dsp.html#sge.dsp.Object" title="sge.dsp.Object"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Object</span></code></a> will be defined by
passing their values to <a class="reference internal" href="dsp.html#sge.dsp.Object.__init__" title="sge.dsp.Object.__init__"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Object.__init__()</span></code></a>, which we will
call with <code class="docutils literal"><span class="pre">super().__init__(*args,</span> <span class="pre">**kwargs)</span></code>.  This makes our
<code class="xref py py-meth docutils literal"><span class="pre">Player.__init__()</span></code> defintion an extension, rather than an override,
of <a class="reference internal" href="dsp.html#sge.dsp.Object.__init__" title="sge.dsp.Object.__init__"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Object.__init__()</span></code></a>, which is important; overriding this
method would be likely to break something.</p>
<p>Our definition of <code class="xref py py-meth docutils literal"><span class="pre">Player.__init__`()</span></code> ends up looking something
like this:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">player</span><span class="p">):</span>
    ...
    <span class="nb">super</span><span class="p">()</span><span class="o">.</span><span class="n">__init__</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">sprite</span><span class="o">=</span><span class="n">paddle_sprite</span><span class="p">,</span> <span class="n">checks_collisions</span><span class="o">=</span><span class="bp">False</span><span class="p">)</span>
</pre></div>
</div>
...
accordingly.</p>
<p><a class="reference internal" href="keyboard.html#sge.keyboard.get_pressed" title="sge.keyboard.get_pressed"><code class="xref py py-func docutils literal"><span class="pre">sge.keyboard.get_pressed()</span></code></a> returns the state of a key on the
...
<a class="reference internal" href="dsp.html#sge.dsp.Object.event_step" title="sge.dsp.Object.event_step"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Object.event_step()</span></code></a>, is an event which always executes
every frame.</p>
<p>What we will do is subtract the state of <code class="xref py py-attr docutils literal"><span class="pre">up_key</span></code> from the state
of <code class="xref py py-attr docutils literal"><span class="pre">down_key</span></code>.  This will give us <code class="docutils literal"><span class="pre">-1</span></code> if only <code class="xref py py-attr docutils literal"><span class="pre">up_key</span></code> is
pressed, <code class="docutils literal"><span class="pre">1</span></code> if only <code class="xref py py-attr docutils literal"><span class="pre">down_key</span></code> is pressed, and <code class="docutils literal"><span class="pre">0</span></code> if neither
or both keys are pressed.  We can multiply this result by a constant,
which we will call <code class="xref py py-const docutils literal"><span class="pre">PADDLE_SPEED</span></code>, to get the amount that the
paddle should move this frame, and assign this value to the player&#8217;s
<a class="reference internal" href="dsp.html#sge.dsp.Object.yvelocity" title="sge.dsp.Object.yvelocity"><code class="xref py py-attr docutils literal"><span class="pre">sge.dsp.Object.yvelocity</span></code></a>, an attribute which indicates the
number of pixels an object will move vertically each frame.  We will
define <code class="xref py py-const docutils literal"><span class="pre">PADDLE_SPEED</span></code> as <code class="docutils literal"><span class="pre">4</span></code>.</p>
...
player object&#8217;s <code class="xref py py-attr docutils literal"><span class="pre">bbox_top</span></code> and <code class="xref py py-attr docutils literal"><span class="pre">bbox_bottom</span></code> values; these
indicate the current location of the object&#8217;s bounding box.  If
<code class="xref py py-attr docutils literal"><span class="pre">bbox_top</span></code> is less than <code class="docutils literal"><span class="pre">0</span></code>, we will set it to <code class="docutils literal"><span class="pre">0</span></code>.  If
<code class="xref py py-attr docutils literal"><span class="pre">bbox_bottom</span></code> is greater than <code class="docutils literal"><span class="pre">sge.game.current_room.height</span></code>, we
will set it to <code class="docutils literal"><span class="pre">sge.game.current_room.height</span></code>.
<code class="xref py py-attr docutils literal"><span class="pre">sge.game.current_room</span></code>, as its name implies, indicates the
currently running <code class="xref py py-class docutils literal"><span class="pre">sge.game.Room</span></code> object.</p>
<p>Our step event ends up looking something like this:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">event_step</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">time_passed</span><span class="p">,</span> <span class="n">delta_mult</span><span class="p">):</span>
...
<p><code class="xref py py-class docutils literal"><span class="pre">Ball</span></code> is the ball.  It is bounced back and forth by the players.
...
<p>Any <code class="xref py py-class docutils literal"><span class="pre">Ball</span></code> object is always going to have the same initial
attributes as any other <code class="xref py py-class docutils literal"><span class="pre">Ball</span></code> object, so much like what we did
with <code class="xref py py-class docutils literal"><span class="pre">Player</span></code>, we are going to define a custom
<code class="xref py py-meth docutils literal"><span class="pre">Ball.__init__()</span></code>.</p>
<p>In this case, it&#8217;s much simpler: <code class="xref py py-attr docutils literal"><span class="pre">x</span></code> and <code class="xref py py-attr docutils literal"><span class="pre">y</span></code> are going to
start at the center of the screen, and <code class="xref py py-attr docutils literal"><span class="pre">sprite</span></code> is going to be
<code class="docutils literal"><span class="pre">ball_sprite</span></code>.  These are attributes inherited from
<a class="reference internal" href="dsp.html#sge.dsp.Object" title="sge.dsp.Object"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Object</span></code></a>, so we indicate them in a call to
<code class="docutils literal"><span class="pre">super().__init__</span></code>.  <code class="xref py py-meth docutils literal"><span class="pre">Ball.__init__()</span></code> ends up as:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    ...
    <span class="n">y</span> <span class="o">=</span> <span class="n">sge</span><span class="o">.</span><span class="n">game</span><span class="o">.</span><span class="n">height</span> <span class="o">/</span> <span class="mi">2</span>
    <span class="nb">super</span><span class="p">()</span><span class="o">.</span><span class="n">__init__</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">sprite</span><span class="o">=</span><span class="n">ball_sprite</span><span class="p">)</span>
</pre></div>
</div>
<p>Since we want to serve the ball both at the start of the game and every
time the ball passes a player, we should define a <code class="xref py py-meth docutils literal"><span class="pre">Ball.serve()</span></code>
...
<p>For the first task, we can use <a class="reference internal" href="dsp.html#sge.dsp.Object.xstart" title="sge.dsp.Object.xstart"><code class="xref py py-attr docutils literal"><span class="pre">sge.dsp.Object.xstart</span></code></a> and
<a class="reference internal" href="dsp.html#sge.dsp.Object.ystart" title="sge.dsp.Object.ystart"><code class="xref py py-attr docutils literal"><span class="pre">sge.dsp.Object.ystart</span></code></a>.  These attributes indicate the original
position of an object when it was first created, which in the case of
<code class="xref py py-class docutils literal"><span class="pre">Ball</span></code> objects is in the center of the screen.</p>
<p>For the second task, we have an argument called <code class="docutils literal"><span class="pre">direction</span></code>.  If it is
<code class="xref py py-const docutils literal"><span class="pre">None</span></code>, it randomly becomes either <code class="docutils literal"><span class="pre">1</span></code> or <code class="docutils literal"><span class="pre">-1</span></code>.  The
value is then multiplied by a constant called <code class="xref py py-const docutils literal"><span class="pre">BALL_START_SPEED</span></code>,
which we will set to <code class="docutils literal"><span class="pre">2</span></code>, and this becomes the ball&#8217;s
<a class="reference internal" href="dsp.html#sge.dsp.Object.xvelocity" title="sge.dsp.Object.xvelocity"><code class="xref py py-attr docutils literal"><span class="pre">sge.dsp.Object.xvelocity</span></code></a> value.  The ball&#8217;s
<a class="reference internal" href="dsp.html#sge.dsp.Object.yvelocity" title="sge.dsp.Object.yvelocity"><code class="xref py py-attr docutils literal"><span class="pre">sge.dsp.Object.yvelocity</span></code></a> value is then set to <code class="docutils literal"><span class="pre">0</span></code>.</p>
<p>The result looks like this:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">serve</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">direction</span><span class="o">=</span><span class="bp">None</span><span class="p">):</span>
...
<p class="last">Since we are now using the <code class="xref py py-mod docutils literal"><span class="pre">random</span></code> module, we need to also
...
<a class="reference internal" href="dsp.html#sge.dsp.Object.event_create" title="sge.dsp.Object.event_create"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Object.event_create()</span></code></a>.  The create event happens whenever
the object is created in the room.  This is the create event of
<code class="xref py py-class docutils literal"><span class="pre">Ball</span></code>:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">event_create</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    <span class="bp">self</span><span class="o">.</span><span class="n">serve</span><span class="p">()</span>
</pre></div>
</div>
<p>For <code class="xref py py-class docutils literal"><span class="pre">Ball</span></code>&#8216;s step event, we need to do two things: cause the ball
...
<p>For the first task, we do the same thing we did with <code class="xref py py-class docutils literal"><span class="pre">Player</span></code>,
but we also set whether <code class="xref py py-attr docutils literal"><span class="pre">yvelocity</span></code> is positive or negative; we
...
just touching the edge.  We do this by checking <code class="xref py py-attr docutils literal"><span class="pre">bbox_right</span></code>
against the left edge, and <code class="xref py py-attr docutils literal"><span class="pre">bbox_left</span></code> against the right edge.
...
<p>Our step event for <code class="xref py py-class docutils literal"><span class="pre">Ball</span></code> ends up looking something like this:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">event_step</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">time_passed</span><span class="p">,</span> <span class="n">delta_mult</span><span class="p">):</span>
...
<a class="reference internal" href="dsp.html#sge.dsp.Object.event_collision" title="sge.dsp.Object.event_collision"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Object.event_collision()</span></code></a>, occur when two objects touch
each other.</p>
<p>We first need to verify what type of object we&#8217;re colliding with.  The
most straightforward way is to use <code class="xref py py-func docutils literal"><span class="pre">isinstance()</span></code> to check whether
or not the object being collided with, which is passed on to the
<code class="docutils literal"><span class="pre">other</span></code> argument, is an instance of <code class="xref py py-class docutils literal"><span class="pre">Player</span></code>.  We write the
...
detection, but we are going to instead use <code class="xref py py-attr docutils literal"><span class="pre">Player.hit_direction</span></code>
to determine what to do.  If the <code class="xref py py-attr docutils literal"><span class="pre">other.hit_direction</span></code> is <code class="docutils literal"><span class="pre">1</span></code>,
...
acceleration in a constant called <code class="xref py py-const docutils literal"><span class="pre">BALL_ACCELERATION</span></code>, which we
will define as <code class="docutils literal"><span class="pre">0.2</span></code>.  We will then set <code class="xref py py-attr docutils literal"><span class="pre">self.xvelocity</span></code> to
<code class="docutils literal"><span class="pre">(abs(self.xvelocity)</span> <span class="pre">+</span> <span class="pre">BALL_ACCELERATION)</span> <span class="pre">*</span> <span class="pre">other.hit_direction</span></code>.</p>
<p>We also need to make the ball&#8217;s vertical movement change based on where
it hits the paddle.  To do this, we will subtract <code class="xref py py-attr docutils literal"><span class="pre">other.y</span></code> from
<code class="xref py py-attr docutils literal"><span class="pre">self.y</span></code> and multiply that by a constant called
<code class="xref py py-const docutils literal"><span class="pre">PADDLE_VERTICAL_FORCE</span></code>, which we will define as <code class="docutils literal"><span class="pre">1</span> <span class="pre">/</span> <span class="pre">12</span></code>; this
value will be added to <code class="xref py py-attr docutils literal"><span class="pre">self.yvelocity</span></code>.</p>
...
<code class="docutils literal"><span class="pre">(abs(self.xvelocity)</span> <span class="pre">+</span> <span class="pre">BALL_ACCELERATION)</span></code> by
<code class="xref py py-attr docutils literal"><span class="pre">other.hit_direction</span></code>, we multiply the smallest out of that, and a
new constant called <code class="xref py py-const docutils literal"><span class="pre">BALL_MAX_SPEED</span></code>, by
<code class="xref py py-attr docutils literal"><span class="pre">other.hit_direction</span></code>.  We will define <code class="xref py py-const docutils literal"><span class="pre">BALL_MAX_SPEED</span></code> as
<code class="docutils literal"><span class="pre">15</span></code>.</p>
<p>Our collision event ends up looking something like this:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">event_collision</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">other</span><span class="p">,</span> <span class="n">xdirection</span><span class="p">,</span> <span class="n">ydirection</span><span class="p">):</span>
...
<p>We are going to pass some arguments to the creation of our <code class="xref py py-class docutils literal"><span class="pre">Game</span></code>
object: we are going to define <code class="docutils literal"><span class="pre">width</span></code> as <code class="docutils literal"><span class="pre">640</span></code>, <code class="docutils literal"><span class="pre">height</span></code> as
<code class="docutils literal"><span class="pre">480</span></code>, <code class="docutils literal"><span class="pre">fps</span></code> as <code class="docutils literal"><span class="pre">120</span></code>, and <code class="docutils literal"><span class="pre">window_text</span></code> as <code class="docutils literal"><span class="pre">&quot;Pong&quot;</span></code>.  Specify
...
<p>Sprites are stored as <a class="reference internal" href="gfx.html#sge.gfx.Sprite" title="sge.gfx.Sprite"><code class="xref py py-class docutils literal"><span class="pre">sge.gfx.Sprite</span></code></a> objects, so we are going
to create two of them:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="n">paddle_sprite</span> <span class="o">=</span> <span class="n">sge</span><span class="o">.</span><span class="n">gfx</span><span class="o">.</span><span class="n">Sprite</span><span class="p">(</span><span class="n">width</span><span class="o">=</span><span class="mi">8</span><span class="p">,</span> <span class="n">height</span><span class="o">=</span><span class="mi">48</span><span class="p">,</span> <span class="n">origin_x</span><span class="o">=</span><span class="mi">4</span><span class="p">,</span> <span class="n">origin_y</span><span class="o">=</span><span class="mi">24</span><span class="p">)</span>
...
<a class="reference internal" href="gfx.html#sge.gfx.Sprite.draw_rectangle" title="sge.gfx.Sprite.draw_rectangle"><code class="xref py py-meth docutils literal"><span class="pre">sge.gfx.Sprite.draw_rectangle()</span></code></a>:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="n">paddle_sprite</span><span class="o">.</span><span class="n">draw_rectangle</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="n">paddle_sprite</span><span class="o">.</span><span class="n">width</span><span class="p">,</span>
...
that list onto <a class="reference internal" href="gfx.html#sge.gfx.Background.__init__" title="sge.gfx.Background.__init__"><code class="xref py py-meth docutils literal"><span class="pre">sge.gfx.Background.__init__()</span></code></a>&#8216;s <code class="docutils literal"><span class="pre">layers</span></code>
argument:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="n">layers</span> <span class="o">=</span> <span class="p">[</span><span class="n">sge</span><span class="o">.</span><span class="n">gfx</span><span class="o">.</span><span class="n">BackgroundLayer</span><span class="p">(</span><span class="n">paddle_sprite</span><span class="p">,</span> <span class="n">sge</span><span class="o">.</span><span class="n">game</span><span class="o">.</span><span class="n">width</span> <span class="o">/</span> <span class="mi">2</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="o">-</span><span class="mi">10000</span><span class="p">,</span>
                                  <span class="n">repeat_up</span><span class="o">=</span><span class="bp">True</span><span class="p">,</span> <span class="n">repeat_down</span><span class="o">=</span><span class="bp">True</span><span class="p">)]</span>
...
<p>The fourth argument of <code class="xref py py-meth docutils literal"><span class="pre">sge.BackgroudLayer.__init__()</span></code> is the
...
closer to the viewer.  The default Z-axis value is <code class="docutils literal"><span class="pre">0</span></code>.  Since we want
...
<p>Don&#8217;t forget to create our objects!  In <code class="xref py py-data docutils literal"><span class="pre">player1</span></code>, store a
<code class="xref py py-class docutils literal"><span class="pre">Player</span></code> object with the <code class="docutils literal"><span class="pre">player</span></code> argument specified as <code class="docutils literal"><span class="pre">1</span></code>.
In <code class="xref py py-data docutils literal"><span class="pre">player2</span></code>, store a <code class="xref py py-class docutils literal"><span class="pre">Player</span></code> object with the <code class="docutils literal"><span class="pre">player</span></code>
argument specified as <code class="docutils literal"><span class="pre">2</span></code>.  Finally, create a <code class="xref py py-class docutils literal"><span class="pre">Ball</span></code> object and
store it in <code class="xref py py-data docutils literal"><span class="pre">ball</span></code>.  Put all of these objects in a list and assign
this list to a variable called <code class="docutils literal"><span class="pre">objects</span></code>.</p>
</div>
...
<p>Create a <code class="xref py py-class docutils literal"><span class="pre">Room</span></code> object.  Specify the first argument as
<code class="docutils literal"><span class="pre">objects</span></code>, and specify the keyword argument <code class="docutils literal"><span class="pre">background</span></code> as
<code class="docutils literal"><span class="pre">background</span></code>.  Don&#8217;t forget to assign it to
<code class="xref py py-attr docutils literal"><span class="pre">sge.game.start_room</span></code>!</p>
</div>
...
this, set <code class="xref py py-attr docutils literal"><span class="pre">sge.game.mouse.visible</span></code> to <code class="xref py py-const docutils literal"><span class="pre">False</span></code>.</p>
</div>
...
<p>Add a call to <code class="xref py py-meth docutils literal"><span class="pre">sge.game.start()</span></code> at the end, under a check for the
value of <code class="xref py py-data docutils literal"><span class="pre">__name__</span></code>.</p>
</div>
</div>
...
<span class="c1"># Written in 2013-2015 by Julie Marchant &lt;onpon4@riseup.net&gt;</span>
<span class="c1">#</span>
...
<span class="k">class</span> <span class="nc">Ball</span><span class="p">(</span><span class="n">sge</span><span class="o">.</span><span class="n">dsp</span><span class="o">.</span><span class="n">Object</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">serve</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">direction</span><span class="o">=</span><span class="bp">None</span><span class="p">):</span>
        <span class="k">if</span> <span class="n">direction</span> <span class="ow">is</span> <span class="bp">None</span><span class="p">:</span>
            <span class="n">direction</span> <span class="o">=</span> <span class="n">random</span><span class="o">.</span><span class="n">choice</span><span class="p">([</span><span class="o">-</span><span class="mi">1</span><span class="p">,</span> <span class="mi">1</span><span class="p">])</span>
...
<span class="n">sge</span><span class="o">.</span><span class="n">game</span><span class="o">.</span><span class="n">mouse</span><span class="o">.</span><span class="n">visible</span> <span class="o">=</span> <span class="bp">False</span>
...
game more on par with Atari&#8217;s original Pong.</p>
  ...
  <ul>
<li><a class="reference internal" href="#">Tutorial 2: Pong</a><ul>
<li><a class="reference internal" href="#adding-game-logic">Adding Game Logic</a><ul>
<li><a class="reference internal" href="#the-game-class">The Game Class</a></li>
<li><a class="reference internal" href="#the-object-classes">The Object Classes</a><ul>
...
<li><a class="reference internal" href="#starting-the-game">Starting the Game</a><ul>
<li><a class="reference internal" href="#loading-sprites">Loading Sprites</a></li>
<li><a class="reference internal" href="#loading-backgrounds">Loading Backgrounds</a></li>
<li><a class="reference internal" href="#creating-objects">Creating Objects</a></li>
<li><a class="reference internal" href="#creating-rooms">Creating Rooms</a></li>
<li><a class="reference internal" href="#making-the-mouse-invisible">Making the Mouse Invisible</a></li>
<li><a class="reference internal" href="#id1">Starting the Game</a></li>
</ul>
</li>
<li><a class="reference internal" href="#the-final-result">The Final Result</a></li>
</ul>
</li>
</ul>
  ...
  <p class="topless"><a href="hello_world.html"
                        title="previous chapter">Tutorial 1: Hello, world!</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="pong_better.html"
                        title="next chapter">Tutorial 3: Better Pong</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="_sources/pong.txt"
