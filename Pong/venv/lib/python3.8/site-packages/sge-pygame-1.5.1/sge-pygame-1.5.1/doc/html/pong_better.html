...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Tutorial 3: Better Pong &mdash; SGE Game Engine 1.5 documentation</title>
  ...
  <body role="document">
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="pong.html" title="Tutorial 2: Pong"
...
<p>We are going to need a new global variable: <code class="xref py py-data docutils literal"><span class="pre">game_in_progress</span></code>.
...
Enter key is pressed.  Set it to <code class="xref py py-const docutils literal"><span class="pre">True</span></code> by default.</p>
<p>To make pressing Enter start a new game, we will check
<code class="xref py py-data docutils literal"><span class="pre">game_in_progress</span></code>.  If a game is in progress, we will pause the
game, as we had it do previously.  Otherwise, we will set
<code class="xref py py-data docutils literal"><span class="pre">game_in_progress</span></code> to <code class="xref py py-const docutils literal"><span class="pre">True</span></code> and restart the room.</p>
<p>If you look through the documentation for <a class="reference internal" href="dsp.html#sge.dsp.Room" title="sge.dsp.Room"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Room</span></code></a>, you may
...
of the room into a new function, <code class="xref py py-func docutils literal"><span class="pre">create_room()</span></code>.  Our definition of
<code class="xref py py-meth docutils literal"><span class="pre">Game.event_key_press()</span></code> becomes:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">event_key_press</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">key</span><span class="p">,</span> <span class="n">char</span><span class="p">):</span>
    ...
    <span class="k">elif</span> <span class="n">key</span> <span class="ow">in</span> <span class="p">(</span><span class="s1">&#39;p&#39;</span><span class="p">,</span> <span class="s1">&#39;enter&#39;</span><span class="p">):</span>
        ...
        <span class="k">else</span><span class="p">:</span>
            <span class="n">game_in_progress</span> <span class="o">=</span> <span class="bp">True</span>
            <span class="n">create_room</span><span class="p">()</span><span class="o">.</span><span class="n">start</span><span class="p">()</span>
</pre></div>
</div>
<p>Now, we need to define <code class="xref py py-func docutils literal"><span class="pre">create_room()</span></code>.  This is very simple; we
just copy and paste the code we used at the bottom to create the room
into it, but specify that <code class="xref py py-data docutils literal"><span class="pre">player</span></code> and <code class="xref py py-data docutils literal"><span class="pre">player2</span></code> are global.
Our function is as follows:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">create_room</span><span class="p">():</span>
...
will replace it with a call to <code class="xref py py-func docutils literal"><span class="pre">create_room()</span></code>.</p>
</div>
...
<p>We now need to add score attributes to the <code class="xref py py-class docutils literal"><span class="pre">Player</span></code> objects.  We
will initialize the new attribute, <code class="xref py py-attr docutils literal"><span class="pre">score</span></code>, in
<code class="xref py py-meth docutils literal"><span class="pre">Player.event_create()</span></code> as <code class="docutils literal"><span class="pre">0</span></code>.</p>
<p>Now, in <code class="xref py py-meth docutils literal"><span class="pre">Ball.event_step()</span></code>, add lines to increase
<code class="xref py py-attr docutils literal"><span class="pre">player1.score</span></code> and <code class="xref py py-attr docutils literal"><span class="pre">player2.score</span></code> whenever the respective
...
<a class="reference internal" href="dsp.html#sge.dsp.Game.project_text" title="sge.dsp.Game.project_text"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Game.project_text()</span></code></a> or <a class="reference internal" href="dsp.html#sge.dsp.Room.project_text" title="sge.dsp.Room.project_text"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Room.project_text()</span></code></a>.
...
<p>We need to add a new global variable called <code class="xref py py-data docutils literal"><span class="pre">hud_sprite</span></code>.  Assign
a new sprite to this variable with a <code class="xref py py-attr docutils literal"><span class="pre">width</span></code> of <code class="docutils literal"><span class="pre">320</span></code>, a
<code class="xref py py-attr docutils literal"><span class="pre">height</span></code> of <code class="docutils literal"><span class="pre">120</span></code>, an <code class="xref py py-attr docutils literal"><span class="pre">origin_x</span></code> of <code class="docutils literal"><span class="pre">160</span></code>, and an
<code class="xref py py-attr docutils literal"><span class="pre">origin_y</span></code> of <code class="docutils literal"><span class="pre">0</span></code>.</p>
<p>To draw text, we need a font.  Create a new <a class="reference internal" href="gfx.html#sge.gfx.Font" title="sge.gfx.Font"><code class="xref py py-class docutils literal"><span class="pre">sge.gfx.Font</span></code></a> object
and assign it to <code class="xref py py-data docutils literal"><span class="pre">hud_font</span></code>.  For now, we will use a system font.
I am choosing <code class="docutils literal"><span class="pre">&quot;Droid</span> <span class="pre">Sans</span> <span class="pre">Mono&quot;</span></code>, but you can choose whatever font
you prefer.  Pass your choice as the first argument to
<a class="reference internal" href="gfx.html#sge.gfx.Font.__init__" title="sge.gfx.Font.__init__"><code class="xref py py-meth docutils literal"><span class="pre">sge.gfx.Font.__init__()</span></code></a>.  Set the <code class="docutils literal"><span class="pre">size</span></code> keyword argument to
<code class="docutils literal"><span class="pre">48</span></code>.</p>
...
the redrawing code into a function, <code class="xref py py-func docutils literal"><span class="pre">refresh_hud()</span></code>.  This function
needs to clear the HUD sprite, draw Player 1&#8217;s score, and then draw
Player 2&#8217;s score.</p>
<p>Another constant is needed: <code class="xref py py-const docutils literal"><span class="pre">TEXT_OFFSET</span></code>, which we will define
as <code class="docutils literal"><span class="pre">16</span></code>.</p>
<p>We clear the HUD sprite with <a class="reference internal" href="gfx.html#sge.gfx.Sprite.draw_clear" title="sge.gfx.Sprite.draw_clear"><code class="xref py py-meth docutils literal"><span class="pre">sge.gfx.Sprite.draw_clear()</span></code></a>.</p>
<p>To draw the text, we use <a class="reference internal" href="gfx.html#sge.gfx.Sprite.draw_text" title="sge.gfx.Sprite.draw_text"><code class="xref py py-meth docutils literal"><span class="pre">sge.gfx.Sprite.draw_text()</span></code></a>.  Both calls
have a few arguments in common: <code class="docutils literal"><span class="pre">font</span></code> is set to <code class="docutils literal"><span class="pre">hud_font</span></code>, <code class="docutils literal"><span class="pre">y</span></code>
is set to <code class="docutils literal"><span class="pre">TEXT_OFFSET</span></code>, <code class="docutils literal"><span class="pre">color</span></code> is set to white, and <code class="docutils literal"><span class="pre">valign</span></code> is
set to <code class="docutils literal"><span class="pre">&quot;top&quot;</span></code>.</p>
<p>The rest of the arguments are different between the two.  <code class="docutils literal"><span class="pre">text</span></code> is
set to the respective player&#8217;s score, converted to a string.  <code class="docutils literal"><span class="pre">x</span></code> is
set to <code class="docutils literal"><span class="pre">hud_sprite.width</span> <span class="pre">/</span> <span class="pre">2</span> <span class="pre">-</span> <span class="pre">TEXT_OFFSET</span></code> for player 1&#8217;s score, and
<code class="docutils literal"><span class="pre">hud_sprite.width</span> <span class="pre">/</span> <span class="pre">2</span> <span class="pre">+</span> <span class="pre">TEXT_OFFSET</span></code> for player 2&#8217;s score.  <code class="docutils literal"><span class="pre">halign</span></code>
is set to <code class="docutils literal"><span class="pre">&quot;right&quot;</span></code> for player 1&#8217;s score, and <code class="docutils literal"><span class="pre">&quot;left&quot;</span></code> for
player 2&#8217;s score.</p>
<p><code class="xref py py-func docutils literal"><span class="pre">refresh_hud()</span></code> ends up something like this:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">refresh_hud</span><span class="p">():</span>
...
<p>Add calls to <code class="xref py py-func docutils literal"><span class="pre">refresh_hud()</span></code> in the three places where a
<code class="xref py py-attr docutils literal"><span class="pre">Player.score</span></code> value changes, right after the change.  These
places are in <code class="xref py py-meth docutils literal"><span class="pre">Player.event_create()</span></code> and <code class="xref py py-meth docutils literal"><span class="pre">Ball.event_step()</span></code>.</p>
<p>we have one more problem.  <code class="xref py py-func docutils literal"><span class="pre">refresh_hud()</span></code> requires <code class="xref py py-data docutils literal"><span class="pre">player1</span></code>
and <code class="xref py py-data docutils literal"><span class="pre">player2</span></code> to each have an attribute called <code class="xref py py-attr docutils literal"><span class="pre">score</span></code>, but
...
attribute to <code class="xref py py-class docutils literal"><span class="pre">Player</span></code> called <code class="xref py py-attr docutils literal"><span class="pre">score</span></code>, and set it to <code class="docutils literal"><span class="pre">0</span></code>.
This will cause <code class="xref py py-attr docutils literal"><span class="pre">player1.score</span></code> and <code class="xref py py-attr docutils literal"><span class="pre">player2.score</span></code> to be
<code class="docutils literal"><span class="pre">0</span></code> in the event that the respective object&#8217;s <code class="xref py py-attr docutils literal"><span class="pre">score</span></code> has not
...
this simply by adding a step event to <code class="xref py py-class docutils literal"><span class="pre">Game</span></code> which projects the
...
<p>Unlike <a class="reference internal" href="dsp.html#sge.dsp.Room" title="sge.dsp.Room"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Room</span></code></a> projections, <a class="reference internal" href="dsp.html#sge.dsp.Game" title="sge.dsp.Game"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Game</span></code></a>
...
<a class="reference internal" href="dsp.html#sge.dsp.Game" title="sge.dsp.Game"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Game</span></code></a> projection instead of a <a class="reference internal" href="dsp.html#sge.dsp.Room" title="sge.dsp.Room"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Room</span></code></a>
projection or <a class="reference internal" href="dsp.html#sge.dsp.Object" title="sge.dsp.Object"><code class="xref py py-class docutils literal"><span class="pre">sge.dsp.Object</span></code></a> object.</p>
<div class="admonition note">
<p class="first admonition-title">Note</p>
...
<a class="reference internal" href="dsp.html#sge.dsp.Game.event_paused_step" title="sge.dsp.Game.event_paused_step"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Game.event_paused_step()</span></code></a>, as well.</p>
</div>
</div>
</div>
...
<p>Define a new constant called <code class="xref py py-const docutils literal"><span class="pre">POINTS_TO_WIN</span></code> as <code class="docutils literal"><span class="pre">10</span></code>.</p>
<p>In our case, the most convenient place to check for victory is within
<code class="xref py py-meth docutils literal"><span class="pre">Ball.serve()</span></code>.  Specifically, put the code that sets the speed of
the ball under a conditional that checks whether the <code class="xref py py-attr docutils literal"><span class="pre">score</span></code>
values of both players are less than <code class="xref py py-const docutils literal"><span class="pre">POINTS_TO_WIN</span></code>.  Add an
<code class="docutils literal"><span class="pre">else</span></code> block below that.  This is where a player has won the game.</p>
<p>Since the game is over, stop the movement of the ball by setting
<code class="xref py py-attr docutils literal"><span class="pre">xvelocity</span></code> and <code class="xref py py-attr docutils literal"><span class="pre">yvelocity</span></code> to <code class="docutils literal"><span class="pre">0</span></code>.  We don&#8217;t want any
more scoring to happen.</p>
<p>Now, draw the new text onto the HUD.  We do this using the same call to
<a class="reference internal" href="gfx.html#sge.gfx.Sprite.draw_text" title="sge.gfx.Sprite.draw_text"><code class="xref py py-meth docutils literal"><span class="pre">sge.gfx.Sprite.draw_text()</span></code></a> we used in <code class="xref py py-func docutils literal"><span class="pre">refresh_hud()</span></code>, except
instead of drawing the scores converted to strings, we draw <code class="docutils literal"><span class="pre">&quot;WIN&quot;</span></code> or
<code class="docutils literal"><span class="pre">&quot;LOSE&quot;</span></code> depending on whether or not the respective player&#8217;s score is
greater than the other player&#8217;s score.</p>
<p>Finally, set <code class="xref py py-data docutils literal"><span class="pre">game_in_progress</span></code> to <code class="xref py py-const docutils literal"><span class="pre">False</span></code>.  Don&#8217;t forget
to declare it with <code class="docutils literal"><span class="pre">global</span></code> first.</p>
<p>The new <code class="xref py py-meth docutils literal"><span class="pre">Ball.serve()</span></code> looks something like this:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="k">def</span> <span class="nf">serve</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">direction</span><span class="o">=</span><span class="bp">None</span><span class="p">):</span>
    ...
    <span class="k">else</span><span class="p">:</span>
        ...
        <span class="n">hud_sprite</span><span class="o">.</span><span class="n">draw_text</span><span class="p">(</span><span class="n">hud_font</span><span class="p">,</span> <span class="n">p2text</span><span class="p">,</span> <span class="n">x</span> <span class="o">+</span> <span class="n">TEXT_OFFSET</span><span class="p">,</span>
                             <span class="n">TEXT_OFFSET</span><span class="p">,</span> <span class="n">color</span><span class="o">=</span><span class="n">sge</span><span class="o">.</span><span class="n">gfx</span><span class="o">.</span><span class="n">Color</span><span class="p">(</span><span class="s2">&quot;white&quot;</span><span class="p">),</span>
                             <span class="n">halign</span><span class="o">=</span><span class="s2">&quot;left&quot;</span><span class="p">,</span> <span class="n">valign</span><span class="o">=</span><span class="s2">&quot;top&quot;</span><span class="p">)</span>
        <span class="n">game_in_progress</span> <span class="o">=</span> <span class="bp">False</span>
</pre></div>
</div>
</div>
</div>
...
<p>Sounds in the SGE are stored in <a class="reference internal" href="snd.html#sge.snd.Sound" title="sge.snd.Sound"><code class="xref py py-class docutils literal"><span class="pre">sge.snd.Sound</span></code></a> objects.  As the
...
<code class="xref py py-mod docutils literal"><span class="pre">os</span></code> module, so be sure to add this to your list of imports.</p>
...
<div class="highlight-python"><div class="highlight"><pre><span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="s2">&quot;data&quot;</span><span class="p">,</span> <span class="s2">&quot;spam.wav&quot;</span><span class="p">)</span>
</pre></div>
</div>
...
constant called <code class="xref py py-const docutils literal"><span class="pre">DATA</span></code>, indicating the &#8220;data&#8221; directory relative
to the location of pong.py:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="n">DATA</span> <span class="o">=</span> <span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">dirname</span><span class="p">(</span><span class="n">__file__</span><span class="p">),</span> <span class="s2">&quot;data&quot;</span><span class="p">)</span>
</pre></div>
</div>
<p><code class="xref py py-data docutils literal"><span class="pre">__file__</span></code> is a special variable indicating the full path to the
...
folder.  <code class="xref py py-const docutils literal"><span class="pre">DATA</span></code> now indicates the appropriate path to the &#8220;data&#8221;
folder, so from now on, if we want a file called &#8220;spam.wav&#8221; located in
this directory, we use this code:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">DATA</span><span class="p">,</span> <span class="s2">&quot;spam.wav&quot;</span><span class="p">)</span>
</pre></div>
</div>
<p>Assign the appropriate <a class="reference internal" href="snd.html#sge.snd.Sound" title="sge.snd.Sound"><code class="xref py py-class docutils literal"><span class="pre">sge.snd.Sound</span></code></a> objects to
<code class="xref py py-data docutils literal"><span class="pre">bounce_sound</span></code>, <code class="xref py py-data docutils literal"><span class="pre">bounce_wall_sound</span></code>, and
<code class="xref py py-data docutils literal"><span class="pre">score_sound</span></code>.</p>
</div>
...
<p>Sounds are played with <a class="reference internal" href="snd.html#sge.snd.Sound.play" title="sge.snd.Sound.play"><code class="xref py py-meth docutils literal"><span class="pre">sge.snd.Sound.play()</span></code></a>.  Call this method in
...
<p>First, we will add an attribute to <code class="xref py py-class docutils literal"><span class="pre">Player</span></code> indicating what
joystick to use, called <code class="xref py py-attr docutils literal"><span class="pre">joystick</span></code>.  Set it to <code class="docutils literal"><span class="pre">0</span></code> (which is the
first joystick) for player 1, and <code class="docutils literal"><span class="pre">1</span></code> (which is the second joystick)
for player 2.</p>
...
<a class="reference internal" href="joystick.html#sge.joystick.get_axis" title="sge.joystick.get_axis"><code class="xref py py-func docutils literal"><span class="pre">sge.joystick.get_axis()</span></code></a> in the step event of <code class="xref py py-class docutils literal"><span class="pre">Player</span></code>.
Pass <code class="docutils literal"><span class="pre">self.joystick</span></code> as the first argument, and <code class="docutils literal"><span class="pre">1</span></code> (which is the
Y-axis) as the second argument.  Assign it to a variable called
<code class="docutils literal"><span class="pre">axis_motion</span></code>.  Later, we will be modifying the code that sets
<code class="xref py py-attr docutils literal"><span class="pre">yvelocity</span></code> so that it is chosen based on axis position, trackball
...
attribute called <code class="xref py py-attr docutils literal"><span class="pre">trackball_motion</span></code> for that; initialize it as
<code class="docutils literal"><span class="pre">0</span></code> in the create event.</p>
<p>We now need to define the trackball move event, which is defined by
<a class="reference internal" href="dsp.html#sge.dsp.Object.event_joystick_trackball_move" title="sge.dsp.Object.event_joystick_trackball_move"><code class="xref py py-meth docutils literal"><span class="pre">sge.dsp.Object.event_joystick_trackball_move()</span></code></a>.  Within this
event, if the <code class="docutils literal"><span class="pre">joystick</span></code> argument is the same as <code class="docutils literal"><span class="pre">self.joystick</span></code>,
add <code class="docutils literal"><span class="pre">y</span></code> to <code class="docutils literal"><span class="pre">self.trackball_motion</span></code>.  We are adding to it, rather
...
<div class="highlight-python"><div class="highlight"><pre><span class="bp">self</span><span class="o">.</span><span class="n">yvelocity</span> <span class="o">=</span> <span class="n">key_motion</span> <span class="o">*</span> <span class="n">PADDLE_SPEED</span>
</pre></div>
</div>
...
<ul class="simple">
<li>If the absolute value of <code class="docutils literal"><span class="pre">axis_motion</span></code> is greater than the absolute
value of both <code class="docutils literal"><span class="pre">key_motion</span></code> and <code class="xref py py-attr docutils literal"><span class="pre">trackball_motion</span></code>, set
<code class="xref py py-attr docutils literal"><span class="pre">yvelocity</span></code> to <code class="docutils literal"><span class="pre">axis_motion</span> <span class="pre">*</span> <span class="pre">PADDLE_SPEED</span></code>.</li>
<li>Otherwise, if <code class="xref py py-attr docutils literal"><span class="pre">trackball_motion</span></code> is greater than <code class="docutils literal"><span class="pre">key_motion</span></code>,
set <code class="xref py py-attr docutils literal"><span class="pre">yvelocity</span></code> to <code class="docutils literal"><span class="pre">self.trackball_motion</span> <span class="pre">*</span> <span class="pre">PADDLE_SPEED</span></code></li>
<li>Otherwise, use the line we have been using up until this point.</li>
</ul>
<p>After this, we must set <code class="xref py py-attr docutils literal"><span class="pre">trackball_motion</span></code> to <code class="docutils literal"><span class="pre">0</span></code>.</p>
</div>
</div>
...
<span class="n">DATA</span> <span class="o">=</span> <span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">dirname</span><span class="p">(</span><span class="n">__file__</span><span class="p">),</span> <span class="s2">&quot;data&quot;</span><span class="p">)</span>
...
<span class="k">if</span> <span class="n">__name__</span> <span class="o">==</span> <span class="s1">&#39;__main__&#39;</span><span class="p">:</span>
  ...
  <ul>
<li><a class="reference internal" href="#">Tutorial 3: Better Pong</a><ul>
<li><a class="reference internal" href="#adding-scoring">Adding Scoring</a><ul>
<li><a class="reference internal" href="#making-enter-restart-the-game">Making Enter Restart the Game</a></li>
<li><a class="reference internal" href="#giving-points-to-the-players">Giving Points to the Players</a></li>
<li><a class="reference internal" href="#displaying-the-scores">Displaying the Scores</a><ul>
<li><a class="reference internal" href="#new-resources">New Resources</a></li>
<li><a class="reference internal" href="#drawing-the-hud">Drawing the HUD</a></li>
<li><a class="reference internal" href="#displaying-the-hud">Displaying the HUD</a></li>
</ul>
</li>
<li><a class="reference internal" href="#giving-victory">Giving Victory</a></li>
</ul>
</li>
<li><a class="reference internal" href="#adding-sounds">Adding Sounds</a><ul>
<li><a class="reference internal" href="#getting-the-sounds">Getting the Sounds</a></li>
<li><a class="reference internal" href="#loading-the-sounds">Loading the Sounds</a></li>
<li><a class="reference internal" href="#playing-the-sounds">Playing the Sounds</a></li>
</ul>
</li>
<li><a class="reference internal" href="#adding-joystick-support">Adding Joystick Support</a><ul>
<li><a class="reference internal" href="#axis-movement">Axis Movement</a></li>
<li><a class="reference internal" href="#trackball-movement">Trackball Movement</a></li>
<li><a class="reference internal" href="#applying-the-joystick-controls">Applying the Joystick Controls</a></li>
</ul>
</li>
<li><a class="reference internal" href="#the-final-result">The Final Result</a></li>
  ...
  <p class="topless"><a href="pong.html"
                        title="previous chapter">Tutorial 2: Pong</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="input.html"
                        title="next chapter">sge.input</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="_sources/pong_better.txt"
